...
interface UseVisualisationDimensionsParams {
  dimensions?: Partial<Omit<VisualisationDimensions, 'boundedHeight' | 'boundedWidth'>>
  element: ElementRef<Element> | null
}

export interface VisualisationDimensions {
...
export function useVisualisationDimensions(
  params: UseVisualisationDimensionsParams,
): VisualisationDimensions {
